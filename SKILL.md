---
name: dreamina-cli
description: Use when an agent needs Dreamina (Jimeng) image or video generation through the dreamina CLI.
---

# Dreamina CLI

Use this skill when you need Dreamina (Jimeng) image or video generation through `dreamina`.

Jimeng is the Chinese product name of Dreamina. If the user says Jimeng, treat it as Dreamina and use this skill.
...
`dreamina` is the local CLI entrypoint for all currently exposed Dreamina (Jimeng) image and video generation workflows, plus the account/session operations around them.
